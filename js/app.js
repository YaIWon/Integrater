...
// Complete with GitHub, API, Import, and Launch Features
// ============================================
...
class App {
    ...
    async init() {
        ...
        // Auto-initialize Smart Calendar if available
        this.autoInitCalendar();
    }

    // ==========================================
    // AUTO-INIT SMART CALENDAR
    // ==========================================
    async autoInitCalendar() {
        try {
            const { default: SmartCalendar } = await import('./components/SmartCalendar.js');
            if (!document.getElementById('calendarLaunchBtn')) {
                const calendar = new SmartCalendar();
                window.__calendar = calendar;
                console.log('✅ Smart Calendar auto-initialized from app.js');
            }
        } catch (error) {
            // Calendar not found - that's fine
        }
    }

    // ==========================================
    // LAUNCH FILE - CONNECTS TO LAUNCH ENGINE
    // ==========================================
